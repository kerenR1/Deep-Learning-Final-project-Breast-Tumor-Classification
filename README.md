...
Repository Contents:
BreakHis_binary_Baseline_A.py: Baseline model using a 1:1 binary classification approach.

BreakHis_binary_Baseline_B.py: Advanced baseline using Patient ID-based splitting to prevent data leakage and ensure images from the same patient aren't shared across sets.
